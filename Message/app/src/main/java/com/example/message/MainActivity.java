...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mButtoSet = findViewById(R.id.button_set);

        mButtoSet.setOnClickListener(new View.OnClickListener() {
            @Override
    ...
    public void onSend(View v){
        ...
        if (checkPermission(Manifest.permission.SEND_SMS)){
            ...
            smsManager.sendTextMessage(phoneNumber, null, "Ich fahre von " + start2 + " nach " + destination2, null, null);
